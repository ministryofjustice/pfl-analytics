...
with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
    ...
    weekly_summary.to_excel(writer, sheet_name='Weekly_Page_Visits', index=False)
    final_completion.to_excel(writer, sheet_name='Weekly_Completion_Rate', index=False)
